...
public class Signup extends JFrame implements ActionListener{
  ...
  //  JDateChooser dateChooser;
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String ac =(String)c1.getSelectedItem();//here we can not put obj directly in string hence we have typecasted 
        String bc =(String)c2.getSelectedItem();// c1, c2, c3 are objects of date month and year String
